                ...
                */}
                ...
                <form className = "w-full h-full">
                    <div className = "w-full h-11 flex justify-between items-center mb-5">
                        ...
                        <input type  = "text" id = "title" className = "border border-gray-400 w-4/5 h-full rounded-lg p-3"></input>
                    </div>
                    ...
                    <div className = "w-full h-11 flex justify-between items-center mb-5">
                        <div className = "flex">
                            ...
                            <label for = "location" className = "ml-0.5">위치</label>
                        </div>
                        <input type  = "text" id = "location" className = "border border-gray-400 w-4/5 h-full rounded-lg p-3"></input>
                    </div>

                    <div className = "w-full h-11 flex justify-between items-center mb-5">
                        <div className = "flex">
                            <img width="24" height="24" src="https://img.icons8.com/material/24/natural-food--v1.png"/>
                            <label for = "plant" className = "ml-0.5">작물</label>
                        </div>
                        <input type  = "text" id = "plant" className = "border border-gray-400 w-4/5 h-full rounded-lg p-3"></input>
                    </div>
                    ...
                    <div className = "w-full h-11 flex justify-between items-center mb-5">
                        ...
                        <input type  = "text" id = "disease" className = "border border-gray-400 w-4/5 h-full rounded-lg p-3"></input>
                    </div>
                    ...
                    <textarea type = "text" id = "text" className = "border border-gray-400 w-full h-24 rounded-lg px-4 py-2"></textarea>
