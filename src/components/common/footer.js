...
<div class="fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-lime-500">
    <div class="grid h-full max-w-lg grid-cols-5 mx-auto font-medium">
        ...
        <button type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 group">
            ...
            <span class="text-sm text-black mt-1.5 group-hover:text-lime-400">Map</span>
        </button>
        ...
        <button type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 group">
            ...
            <span class="text-sm text-black group-hover:text-lime-400 mt-1.5">Inspect</span>
        </button>
        ...
        <button type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 group">
            ...
            <span class="text-sm text-black mt-1.5 group-hover:text-lime-400">Profile</span>
        </button>
    </div>
</div>
